...
from src.scraping import client as client_module
from src.scraping.client import Client, list_ats, search
from src.scraping.exceptions import ManifestError, StorageError
...
def stub_client(
    ...
    so no HTTP happens.
    """
    from src.scraping.manifest import Manifest
