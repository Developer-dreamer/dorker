...
from src.scraping.scrapers import (
    EightfoldScraper,
    ScraperRegistry,
    get_scraper,
)
from src.scraping.scrapers.eightfold import _extract_remote, _format_location, _parse_ts
...
def _fast_retries(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    import src.scraping.scrapers.eightfold as ef
...
def test_client_kind_httpcloak_skips_httpx_probe(monkeypatch) -> None:
    ...
    import src.scraping.scrapers.eightfold as ef_mod
