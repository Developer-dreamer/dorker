...
from src.scraping.scrapers import ProgramathorScraper, ScraperRegistry
from src.scraping.scrapers.programathor import (
    _parse_brl_amount,
    _parse_salary,
    _resolve_proxy_url,
)
...
def _fast_retries(monkeypatch: pytest.MonkeyPatch) -> None:
    import src.scraping.scrapers.programathor as p
