...
from src.scraping.exceptions import CompanyNotFoundError, ScraperError
from src.scraping.models import ATSType
from src.scraping.scrapers import AvatureScraper, ScraperRegistry, get_scraper
from src.scraping.scrapers.avature import _paginated_search_url


@pytest.fixture(autouse=True)
def _fast_retries(monkeypatch: pytest.MonkeyPatch) -> None:
    import src.scraping.scrapers.avature as av
