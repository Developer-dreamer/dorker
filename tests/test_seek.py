...
from src.scraping.scrapers import ScraperRegistry, SeekScraper
from src.scraping.scrapers.seek import SEEK_SITES, _parse_iso8601


@pytest.fixture(autouse=True)
def _fast_retries(monkeypatch: pytest.MonkeyPatch) -> None:
    import src.scraping.scrapers.seek as seek_mod
...
def test_short_page_stops_scheduling_later_pages(httpx_mock, monkeypatch) -> None:
    import src.scraping.scrapers.seek as module
