...
from src.scraping.scrapers import JobsCzScraper, ScraperRegistry, get_scraper
...
def test_parse_salary_handles_zwj_and_nbsp() -> None:
    ...
    before matching."""
    from src.scraping.scrapers.jobs_cz import _normalize_whitespace, _parse_salary
...
def test_missing_bs4_raises_scraper_error(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    from src.scraping.scrapers.jobs_cz import _parse_listing
