...
from src.scraping.scrapers import BundesagenturScraper
...
def _fast_retries(monkeypatch: pytest.MonkeyPatch) -> None:
    import src.scraping.scrapers.bundesagentur as ba
...
def test_partition_ignores_non_exhaustive_facets() -> None:
    from src.scraping.scrapers.bundesagentur import _select_partition
