...
from src.scraping.scrapers import JazzHRScraper, ScraperRegistry, get_scraper
...
def test_404_does_not_retry(monkeypatch, httpx_mock) -> None:
    from src.scraping import fetch as fetch_module
...
def test_client_kind_httpcloak_skips_httpx(monkeypatch) -> None:
    ...
    import src.scraping.scrapers.jazzhr as jh
