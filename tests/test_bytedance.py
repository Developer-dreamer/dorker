...
from src.scraping.scrapers.bytedance import (
    API_URL,
    PAGE_SIZE,
    BytedanceScraper,
...
def test_ats_type_registered_for_bytedance() -> None:
    ...
    from src.scraping.scrapers.base import ScraperRegistry
...
def test_fetch_retries_transient_response(httpx_mock, monkeypatch) -> None:
    import src.scraping.scrapers.bytedance as module
...
def test_fetch_retries_transient_statuses(httpx_mock, monkeypatch, status) -> None:
    import src.scraping.fetch as fetch_module
