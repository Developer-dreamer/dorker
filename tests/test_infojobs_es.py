...
from src.scraping.scrapers import InfoJobsSpainScraper, ScraperRegistry
from src.scraping.scrapers.infojobs_es import (
    _absolutize_link,
...
def test_live_e2e_fetches_real_infojobs_page() -> None:
    ...
    import src.scraping.scrapers.infojobs_es as ij
