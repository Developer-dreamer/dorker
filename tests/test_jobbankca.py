...
from src.scraping.scrapers import JobBankCAScraper, ScraperRegistry
from src.scraping.scrapers.jobbankca import (
    _infer_country_iso,
    _infer_is_remote,
    _parse_date,
)
...
def _fast_retries(monkeypatch: pytest.MonkeyPatch) -> None:
    import src.scraping.scrapers.jobbankca as jb
...
def test_default_full_run_fails_at_safety_limit(
    ...
    import src.scraping.scrapers.jobbankca as jobbank
