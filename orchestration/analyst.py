...
async def run() -> None:
    ...
    prompts = {
        "rejection": (
            ...
            "Evaluate the job payload and return true if relevant "
            "(software/ai developer/engineer etc.), false if marketing, sales, "
            "or other non-technical."
        ),
    }
    ...
    #                 LEFT JOIN openai_batch_items obi
    #                           ON j.id = obi.job_id
    ...
    await ai.retrieve_batch(batch, conn)
